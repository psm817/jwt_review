package com.example.jwt_review.global.security;

import com.example.jwt_review.global.security.filter.JwtAuthorizationFilter;
        ...
        http
                ...
                .authorizeHttpRequests(
                        authorizeHttpRequests -> authorizeHttpRequests
                                ...
                                .requestMatchers(HttpMethod.GET, "/api/*/articles/*").permitAll() // 상세보기는 누구나 가능
